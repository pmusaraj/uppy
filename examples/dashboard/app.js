...
(() => {
  ...
  var require_Uppy = __commonJS({
    "../packages/@uppy/core/lib/Uppy.js"(exports, module) {
      ...
      var AggregateRestrictionError = class extends AggregateError {
        constructor() {
          super(...arguments);
          this.isRestriction = true;
        }
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
      ...
      function _checkRequiredMetaFieldsOnFile2(file) {
        ...
        const errors = [];
        const missingFields = [];
        for (let i3 = 0; i3 < requiredMetaFields.length; i3++) {
          if (!hasOwnProperty.call(file.meta, requiredMetaFields[i3]) || file.meta[requiredMetaFields[i3]] === "") {
            const err = new RestrictionError(`${this.i18n("missingRequiredMetaFieldOnFile", {
              fileName: file.name
            })}`);
            errors.push(err);
            missingFields.push(requiredMetaFields[i3]);
            _classPrivateFieldLooseBase(this, _showOrLogErrorAndThrow)[_showOrLogErrorAndThrow](err, {
              file,
              showInformer: false,
              throwErr: false
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e4.byteLength}`), e4.tiff && await e4.ensureChunk(this.ifd0Offset, o3(this.options));
  ...
  var ImageEditor = require_lib16();
  var Url = require_lib17();
  var Webcam = require_lib18();
  var Audio = require_lib19();
  var ScreenCapture = require_lib20();
  var Tus = require_lib21();
  var DropTarget = require_lib22();
  var GoldenRetriever = require_lib23();
